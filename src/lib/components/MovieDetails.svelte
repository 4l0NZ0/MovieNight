<script lang="ts">
   let {title,vote_average,overview,posterPath,moviePathAppend,backdrop_path } = $props()
...
<div class="relative pt-48 pb-12 bg-black xl:pt-60 sm:pb-16 lg:pb-32 xl:pb-48 2xl:pb-56">
    ...
    <div class="absolute inset-0">
        <img class="object-cover w-full h-full contrast-125 " src={moviePathAppend+backdrop_path} alt="" />
    </div>
        ...
        <div class="px-6 mx-auto sm:px-8 lg:px-12 max-w-7xl">
            <div class="w-full lg:w-2/3 xl:w-1/2">
                <p class="mt-6 tracking-tighter text-white">
                    <span class="font-sans font-normal text-7xl">{title}</span><br />
                </p>
                <p class="mt-12 font-sans text-base font-normal leading-7 text-white text-opacity-70">{overview}</p>
